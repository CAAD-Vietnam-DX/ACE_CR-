            ...
            if (fName === origName || baseFName === baseOrigName || fName.includes(origName) || origName.includes(baseFName)) {
              ...
              if (trueExtension === "") {
                ...
                if (mimeToExt[fileMimeType]) {
                  trueExtension = mimeToExt[fileMimeType];
                }
              }
